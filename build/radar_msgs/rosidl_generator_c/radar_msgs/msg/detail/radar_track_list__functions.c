...
radar_msgs__msg__RadarTrackList__init(radar_msgs__msg__RadarTrackList * msg)
{
  ...
  // objects
  if (!radar_msgs__msg__RadarTrack__Sequence__init(&msg->objects, 0)) {
    radar_msgs__msg__RadarTrackList__fini(msg);
    return false;
  }
  return true;
}
...
radar_msgs__msg__RadarTrackList__fini(radar_msgs__msg__RadarTrackList * msg)
{
  ...
  // objects
  radar_msgs__msg__RadarTrack__Sequence__fini(&msg->objects);
}
...
radar_msgs__msg__RadarTrackList__create()
{
  ...
  radar_msgs__msg__RadarTrackList * msg = (radar_msgs__msg__RadarTrackList *)allocator.allocate(sizeof(radar_msgs__msg__RadarTrackList), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(radar_msgs__msg__RadarTrackList));
  bool success = radar_msgs__msg__RadarTrackList__init(msg);
  if (!success) {
...
radar_msgs__msg__RadarTrackList__Sequence__init(radar_msgs__msg__RadarTrackList__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  radar_msgs__msg__RadarTrackList * data = NULL;

  if (size) {
    data = (radar_msgs__msg__RadarTrackList *)allocator.zero_allocate(size, sizeof(radar_msgs__msg__RadarTrackList), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = radar_msgs__msg__RadarTrackList__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        radar_msgs__msg__RadarTrackList__fini(&data[i - 1]);
      }
...
radar_msgs__msg__RadarTrackList__Sequence__fini(radar_msgs__msg__RadarTrackList__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      radar_msgs__msg__RadarTrackList__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  radar_msgs__msg__RadarTrackList__Sequence * array = (radar_msgs__msg__RadarTrackList__Sequence *)allocator.allocate(sizeof(radar_msgs__msg__RadarTrackList__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = radar_msgs__msg__RadarTrackList__Sequence__init(array, size);
  if (!success) {
...
radar_msgs__msg__RadarTrackList__Sequence__destroy(radar_msgs__msg__RadarTrackList__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    radar_msgs__msg__RadarTrackList__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
radar_msgs__msg__RadarTrackList__Sequence__are_equal(const radar_msgs__msg__RadarTrackList__Sequence * lhs, const radar_msgs__msg__RadarTrackList__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!radar_msgs__msg__RadarTrackList__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  radar_msgs__msg__RadarTrackList__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(radar_msgs__msg__RadarTrackList);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    radar_msgs__msg__RadarTrackList * data =
      (radar_msgs__msg__RadarTrackList *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!radar_msgs__msg__RadarTrackList__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          radar_msgs__msg__RadarTrackList__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!radar_msgs__msg__RadarTrackList__copy(
