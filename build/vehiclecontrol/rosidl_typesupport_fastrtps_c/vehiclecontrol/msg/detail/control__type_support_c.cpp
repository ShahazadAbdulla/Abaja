...
#include "vehiclecontrol/msg/detail/control__rosidl_typesupport_fastrtps_c.h"
...
#include "vehiclecontrol/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Control__ros_msg_type = vehiclecontrol__msg__Control;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: longswitch
  {
    cdr << ros_message->longswitch;
  }

  // Field name: latswitch
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehiclecontrol
size_t get_serialized_size_vehiclecontrol__msg__Control(
  const void * untyped_ros_message,
...
static uint32_t _Control__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehiclecontrol__msg__Control(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehiclecontrol
size_t max_serialized_size_vehiclecontrol__msg__Control(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehiclecontrol__msg__Control;
    is_plain =
      (
...
static size_t _Control__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehiclecontrol__msg__Control(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehiclecontrol, msg, Control)() {
