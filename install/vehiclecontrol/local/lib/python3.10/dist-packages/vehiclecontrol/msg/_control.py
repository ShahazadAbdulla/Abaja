...
class Metaclass_Control(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('vehiclecontrol')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'vehiclecontrol.msg.Control')
            logger.debug(
...
class Control(metaclass=Metaclass_Control):
    ...
    def __init__(self, **kwargs):
        ...
        self.longswitch = kwargs.get('longswitch', int())
        self.latswitch = kwargs.get('latswitch', int())
    ...
    def __eq__(self, other):
        ...
        if self.brake != other.brake:
            return False
        if self.longswitch != other.longswitch:
            return False
        if self.latswitch != other.latswitch:
            return False
        return True
    ...
    @builtins.property
    def longswitch(self):
        """Message field 'longswitch'."""
        return self._longswitch

    @longswitch.setter
    def longswitch(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'longswitch' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'longswitch' field must be an integer in [-128, 127]"
        self._longswitch = value

    @builtins.property
    def latswitch(self):
        """Message field 'latswitch'."""
        return self._latswitch

    @latswitch.setter
    def latswitch(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'latswitch' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'latswitch' field must be an integer in [-128, 127]"
        self._latswitch = value
